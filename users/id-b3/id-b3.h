...
#define _____________________THUMBS_LF1_____________________ TO(_GAMING), KC_UP, MT(MOD_LSFT, KC_SPC), LT(_SYMNUM, KC_ENT), KC_UP
#define _____________________THUMBS_LF2_____________________ OSM(MOD_LSFT), KC_DOWN

#define _____________________THUMBS_RG1_____________________ KC_LEFT, TD(TD_TABC), KC_BSPC, KC_RIGHT, DF(_QWERTY)
...
#define _____________________GAME_TMB_R_____________________ KC_F5,  KC_F8,  KC_F18,  KC_F17,  KC_BSPC
